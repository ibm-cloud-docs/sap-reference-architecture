...
# Conseils pour SAP sur un environnement IBM Cloud
{: #recommendations}
...
SAP dispose de son propre moteur UME (Users Management Engine) pour gérer les autorisations et l'accès à base de rôle avec l'application SAP. Pour plus d'informations, voir [SAP HANA Security - An Overview](https://archive.sap.com/documents/docs/DOC-62943). Dans une perspective de gestion utilisateur, l'exécution d'{{site.data.keyword.cloud_notm}} sur site par vos systèmes SAP n'est pas pertinente. Des exceptions à cette règle sont mentionnées dans [Serveur jump box](/docs/infrastructure/sap-reference-architecture/sap-ra-architecture.html#juump_box).
